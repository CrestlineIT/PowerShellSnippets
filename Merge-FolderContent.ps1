...
# You have one good folder (like from a backup restore) and you want to overwrite the destination
...
Get-ChildItem -Path $DestinationFolder -File -Recurse | foreach{
	$cnt = $cnt + 1
